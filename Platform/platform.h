...
uint8_t i2c_write(uint8_t addr, void *buf, size_t buf_len);
uint8_t i2c_read(uint8_t addr, void *write_buf, size_t write_buf_len, void *read_buf, size_t read_buf_len);
